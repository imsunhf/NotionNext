                    ...
                    <div className="flex items-center justify-end pr-16 lg:pr-0">
                        ...
                        <div className="hidden sm:flex">
                           ...
                           {siteConfig('STARTER_NAV_BUTTON_1_TEXT', null, CONFIG)}
                            ...
                            className={`signUpBtn ${buttonTextColor} rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark hidden`}
                            >
